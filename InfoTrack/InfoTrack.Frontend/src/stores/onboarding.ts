  ...
  [INITIAL_TOUR_ID]: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'Open Assistant to query solicitor data in plain English. Your local model chooses MCP tools to fetch live counts, searches, and reports from InfoTrack.',
        placement: 'right',
        route: 'insights',
        advanceOnTargetClick: true,
      },
      {
        ...
        body: 'Type a question and press Send. The assistant calls InfoTrack tools against your scrape and analytics data before answering. Keep your local model server running with the configured model loaded.',
        placement: 'top',
        route: 'assistant',
      },
      {
